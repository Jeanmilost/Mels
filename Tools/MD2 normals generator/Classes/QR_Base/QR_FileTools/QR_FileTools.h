...
class QR_FileTools
{
    public:
        ...
        */
        static std::string  GetFileDir(const std::string&  fullPath, bool keepLastChar, QR_Char  delimiter =  '\\');
        static std::wstring GetFileDir(const std::wstring& fullPath, bool keepLastChar, QR_WChar delimiter = L'\\');
        ...
        *@return file name
        */
        static std::string  GetFileName(const std::string&  fullPath, QR_Char  delimiter =  '\\');
        static std::wstring GetFileName(const std::wstring& fullPath, QR_WChar delimiter = L'\\');
        ...
        */
        static std::string  AppendDelimiter(const std::string&  dirName, QR_Char  delimiter =  '\\');
        static std::wstring AppendDelimiter(const std::wstring& dirName, QR_WChar delimiter = L'\\');
