...
// qr engine
#include <TQRVCLModelsRendererGL.hpp>
...
//    THandle hRC;
//
//    std::auto_ptr<TQRVCLModelRendererGL> pRenderer(new TQRVCLModelRendererGL());
//
//    // initialize OpenGL
//    if (!pRenderer->EnableOpenGL((THandle)pOverlayForm->Handle, hDC, hRC))
//        return;
//
//    try
//    {
...
//
//        // create viewport
//        pRenderer->CreateViewport(width, height, true);
//
//        TQRMesh mesh;
//
...
//            pRenderer->BytesFromBitmap(pBitmap.get(), pPixels, false, false);
//            textureIndex = pRenderer->CreateTexture(pBitmap->Width,
//                                                    pBitmap->Height,
...
//        pRenderer->Draw(mesh, matrix, loadedTextures);
//
//        glFlush();
//
//        // create image overlay
//        std::auto_ptr<TBitmap> pOverlay(new TBitmap());
//        pRenderer->GetBitmapFromOpenGL(pOverlay.get());
//
...
//        TQRGDIHelper::ApplyAntialiasing(pOverlay.get(), pAntialiasedOverlay.get(), 4);
//
//        // show final image
...
//    {
//        // shutdown OpenGL
//        pRenderer->DisableOpenGL((THandle)pOverlayForm->Handle, hDC, hRC);
//    }
//
